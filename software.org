...
** AUR helper
*** [[https://rustup.rs/][An installer for the Rust]]
#+begin_src sh
#!/bin/bash
sudo pacman -S rustup
rustup default stable
#+end_src
*** Component for the Rust
#+begin_src sh
...
sudo pacman -S less
#+end_src
*** [[https://github.com/neovim/libvterm][libvterm]]
#+begin_src sh
...
eval "$(opam env)"
#+end_src
*** [[https://github.com/oneapi-src/oneTBB][oneTBB]]
#+begin_src sh
sudo pacman -S tbb
#+end_src
...
#+end_src
*** [[https://www.ocenaudio.com/][ocenaudio]]
#+begin_src sh
